...
const BlogCard = ({ title, description, imgSrc, className = "",id }) => {
  return (
    <div
    ...
    >
      <div className="relative leading-[35px] inline-block text-darkslategray-400 font-poppins mq450:text-xl mq450:leading-[28px] text-left pt-8 text-2xl">
        {title}
      ...
      <div className="self-stretch flex flex-row items-start justify-start gap-[40px] mq450:flex-wrap mq450:gap-[20px]">
        <Link to={`/blog/${id}`} className="text-inherit no-underline">
          <div className="flex flex-col items-start justify-start pt-[69px] px-0 pb-0 box-border min-w-[150px] mq450:flex-1">
            <div className="relative [text-decoration:underline] leading-[40px] text-darkslategray-400 font-poppins mq450:text-xl mq450:leading-[32px] cursor-pointer text-2xl">
              Read More...
            </div>
          </div>
        </Link>
