...
const UseDriverApp2 = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <div className="w-[606px]  mq450:px-6 flex flex-col items-start justify-start gap-[39px] min-w-[606px] max-w-full mq750:gap-[19px] mq750:min-w-full mq1050:flex-1 relative">
        <div className="w-[437px] h-full flex flex-col items-start justify-start gap-[6px] max-w-full">
          <div className="self-stretch h-full relative leading-[55px] inline-block mq450:text-8xl mq450:leading-[33px] mq750:text-17xl mq750:leading-[44px]">
            <p className="m-0 ">
              <span className="">
                {t("use-app.use-driver.useDriverTitle1")}
              </span>{" "}
              <br />
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[12px] max-w-full text-white mq750:flex-wrap relative">
          ...
          <div className="absolute top-[110px] left-[25px] h-[90px] w-[2px] bg-lime-100 mq450:top-[120px]"></div>
        </div>
      </div>
      <div className="h-[500px] w-[343px] flex flex-col items-start justify-start pt-5 mq450:pt-0 px-0 pb-0 box-border min-w-[343px] max-w-full mq450:min-w-full mq1050:flex-1">
...
UseDriverApp2.propTypes = {
  className: PropTypes.string,
};

export default UseDriverApp2;
