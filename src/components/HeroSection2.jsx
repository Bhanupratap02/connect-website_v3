...
const HeroSection2 = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="   z-[5]
 absolute top-[268px] left-[529.4px] w-[635.5px] h-[426.2px]"
      >
        <img
          className=" animate-subtleBounce absolute top-[0px] left-[0px] w-full h-full z-[5]"
          alt=""
          src={Limousine}
        />
        <img
          className=" absolute top-[90.7px] left-[374.7px] w-[79px] h-[289.4px] z-[5]"
          loading="lazy"
          alt=""
          src={Character}
        />
